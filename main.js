...
//             // 创建钱包
            ...
            const classicRouter = getContract(routerABI, contractAddress.swap, wallet);
            // // // 将ETH换成USDC
            ...
            // // 授权USDC
            console.log('开始授权。。。')
            await approveToken(wallet, tokenAddress.usdcAddress, contractAddress.swap, tokenBalance);
